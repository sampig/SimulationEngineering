...
import org.simulation.e05.CircusTrapezeMonteCarlo.AcrobatState;

public class CircusTrapezeMonteCarloApp extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        CircusTrapezeMonteCarlo ct = new CircusTrapezeMonteCarlo();
        ct.start(CircusTrapezeMonteCarlo.STATUS_DYNAMIC);
        ct.outputResult();
